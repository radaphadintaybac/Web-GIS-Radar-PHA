      ...
      <div className="p-2 border shadow-2xl rounded-2xl border-slate-200 bg-white/90 backdrop-blur-md md:rounded-3xl md:p-3 dark:border-slate-700 dark:bg-slate-900/90">
        ...
        <div className="relative mb-2 md:mb-3" ref={dropdownRef}>
          <button
            ...
            className="flex items-center w-full gap-2 p-2 transition-all border rounded-xl border-slate-200 bg-slate-50/50 hover:bg-slate-200 md:gap-3 md:rounded-2xl md:p-2 dark:border-slate-700 dark:bg-slate-800/50 dark:hover:bg-slate-700/80"
          >
        ...
        <div className="flex items-center justify-between gap-1.5">
          <button
            onClick={handlePrev}
            className="flex items-center justify-center w-10 h-10 transition-colors shrink-0 rounded-xl bg-slate-100 text-slate-600 hover:bg-slate-200 md:h-11 md:w-11 md:rounded-2xl dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
            title="Về trước"
          >
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-xl h-10 font-bold shadow-lg transition-all md:h-11 md:rounded-2xl ${
              isPlaying
