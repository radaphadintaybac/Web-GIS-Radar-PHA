        ...
        {dropdownConfigs.map((config) => {
          ...
          return (
            <div key={config.id} className="relative group">
              <button
                className={`flex w-full items-center rounded-xl transition-all ${showText
                  ...
                  {config.options.map((opt, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`mb-1 flex w-full items-center gap-3 rounded-xl p-2 text-sm transition-colors last:mb-0 ${isDeactive
        ...
        {buttonNavItems.map((item, idx) => {
          ...
          return (
            <div key={idx} className="relative group">
              <button
                className={`flex w-full items-center rounded-lg transition-all ${showText ? "p-3" : "justify-center p-2"} ${item.active
